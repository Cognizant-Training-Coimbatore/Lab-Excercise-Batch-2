...
public class feb12_ques5 {

	public static void main(String[] args) throws InterruptedException 
	{
		ExtentReports report = new ExtentReports("Report_FB.html");
		ExtentTest test = report.startTest("feb12_ques3");
		...
		test.log(LogStatus.PASS, "Row size is not verified");
		if(columns.size()==4)
		{
		...
		test.log(LogStatus.PASS, "column size is not verified");
