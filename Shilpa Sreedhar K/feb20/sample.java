...
public class sample {
	...
	@When("^I complete action need to move the  dash board$")
	public void i_complete_action_need_to_move_the_dash_board() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
		driver.findElement(By.id("username")).sendKeys("kyuvaraj@gmail.com");
