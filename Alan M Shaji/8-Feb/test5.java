...
public class test5 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.name("user_login")).sendKeys("Alanmsa07");
		driver.findElement(By.name("user_password")).sendKeys("password");
		driver.findElement(By.name("first_name")).sendKeys("Alan");
		driver.findElement(By.name("last_name")).sendKeys("msa");
		driver.findElement(By.name("email")).sendKeys("Alanmsa07@mail.com");
