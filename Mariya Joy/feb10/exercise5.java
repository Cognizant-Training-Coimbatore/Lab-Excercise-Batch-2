...
public class exercise5 {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.findElement(By.name("user_login")).sendKeys("betty123");
		driver.findElement(By.name("user_password")).sendKeys("betty123");
		driver.findElement(By.name("first_name")).sendKeys("betty");
		driver.findElement(By.name("last_name")).sendKeys("benny");
		driver.findElement(By.name("email")).sendKeys("betty12@gmail.com");
