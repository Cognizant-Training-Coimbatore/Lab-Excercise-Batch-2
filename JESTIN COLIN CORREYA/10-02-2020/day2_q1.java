		...
		public class day2_q1 {
			...
			public static void main(String[] args) throws InterruptedException {
				...
				radio.get(0).click();
				driver.findElement(By.id("FirstName")).sendKeys("COLIN");
				driver.findElement(By.id("LastName")).sendKeys("CORREYA");
				driver.findElement(By.id("Email")).sendKeys("colin@mail.com");
				Thread.sleep(2000);
