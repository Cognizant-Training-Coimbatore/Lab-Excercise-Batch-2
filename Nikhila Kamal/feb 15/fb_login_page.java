...
public class fb_login_page {
	...
	private By submit=By.xpath("//*[@id=\"u_0_13\"]");
	 ...
	 @DataProvider(name = "FB_Login")
	  public Object[][] dp() throws Exception, IOException {
		  Object[][] arrayObject = getExcelData("Downloads\\Datasheet.xls","FB_Login");
  ...
  {
	  log=Logger.getLogger(fb_login_page.class.getName());
		DOMConfigurator.configure("C:\\Users\\Admin\\Desktop\\Java programs\\selenium exampls\\Log4j_config.xml");
